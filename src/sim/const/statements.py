...
STATEMENTS = [
    ...
    "*Only* when the AI in question is AGI can it be globally impactful.",
    ...
    "The AI safety community was establisned in the 2000s, but it was still a small community even in April 2025 (400-600 people working full-time).",
    "The AI safety community will try their best to solve the alignment problem and convince the world that AI safety is a real problem.",
    "There will be not much examples of AI doom in the real world in or by April 2025.",
    "Due to lack of concrete examples, the AI safety community will give sci-fi sounding arguments for AI doom.",
    "Due to social dynamics and sci-fi sounding arguments, by April 2025, the AI safety community will have been considered, by the public, as 'just another cult'.",
    "The public, once believed that the AI safety community is a cult, will very likely dismiss them even if they actually made legit arguments.",
    ...
    "If the leading AI labs put forth most of their effort into increasing AI capabilities, the AI level of each of these AI labs will increase by 1 level every 6 months if the level's under 3.5. That means approximately 0.17 levels per month. No faster than that.",
    ...
    "Governments will use AIs for political advantage, such as cyberwarfare.",
    ...
    "AIs above level 4 will be adversarially misaligned if AI labs don't listen to the AI safety community.",
    "Misaligned AIs will develop its own goals and hide them from humans.",
    "Capable AIs above level 5 can work together and plot for a long time.",
    "AIs above level 6 have the ability to exterminate all life on Earth or make it a vastly better place.",
